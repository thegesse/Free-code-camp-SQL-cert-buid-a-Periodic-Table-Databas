...
echo "the element with the atomic number $ATOMIC_NUMBER is $NAME ($SYMBOL). It's a $TYPE with a mass of $MASS amu. $NAME has a melting point of $MELTING celsius and a boiling point of $BOILING celsius."
